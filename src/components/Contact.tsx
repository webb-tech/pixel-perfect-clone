        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20">
          ...
          >
            ...
            <p className="text-body mb-8">
              Tveka inte att kontakta oss för frågor eller en kostnadsfri offert. 
              Vi återkommer alltid inom 24 timmar.
            </p>
            ...
            <div className="space-y-6">
              ...
              >
                ...
                <div>
                  <p className="text-muted-foreground text-sm">Ring oss</p>
              ...
              >
                ...
                <div>
                  <p className="text-muted-foreground text-sm">Maila oss</p>
                  <p className="text-foreground font-semibold group-hover:text-primary transition-colors">
                    info@dmtak.se
                  </p>
                </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="text-muted-foreground text-sm">Besök oss</p>
