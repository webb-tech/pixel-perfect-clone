            ...
            <div className="max-w-5xl w-[90%] mx-auto">
                ...
                <div className="grid lg:grid-cols-2 gap-8">
                    ...
                    <motion.div
                        ...
                        className="p-8 lg:p-12 relative bg-white rounded-2xl shadow-xl"
                    >
                        {/* Guarantee badge - positioned top right */}
                        <div className="absolute -top-4 -right-4">
                            <img src="/badge.webp" width={120} alt="" />
                        </div>

                        <h3 className="heading-lg text-foreground mb-6 max-w-sm">
                        ...
                        <div className="space-y-4 text-muted-foreground leading-relaxed">
                            ...
                            <p>
                                Vår erfarenhet sträcker sig över 20 år bakåt i
                                tiden och vi är högt rekommenderade av nöjda
                                kunder runt om i hela Stockholm. Allt arbete
                                dokumenteras för att du som kund ska ha en
                                tydlig inblick under arbetets gång och känna dig
                                trygg i ditt val av takläggare.
                            </p>

                            <p>
                                Året om lägger vi tak som är av högsta kvalitet
                                och perfekt anpassade för att klara av det
                                svenska klimatet. 15 års garanti lämnas på
                                utfört arbete och vi jobbar tidseffektivt och
                                utvecklar våra metoder utifrån de senaste rönen
                                och metoderna.
                            </p>

                            <p>
                                Takläggning bygger på ett hantverk som är
                                gammalt, men det är också en bransch där
