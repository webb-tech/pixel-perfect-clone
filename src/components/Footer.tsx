    ...
    <footer className="bg-foreground text-background">
      <div className="section-container py-16">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div>
            <div className="flex items-center mb-6">
              <div className="bg-primary px-3 py-1.5 rounded">
                <span className="text-lg font-bold text-white tracking-wide">DM<span className="mx-1">•</span>TAK</span>
              </div>
            </div>
            ...
            <div className="flex items-center gap-1">
              ...
              <span className="text-background/70 text-sm ml-2">600+ omdömen</span>
            </div>
          </div>

          {/* Tjänster */}
          <div>
            <h4 className="text-background font-semibold mb-6">Tjänster</h4>
          ...
          {/* Företag */}
          <div>
            <h4 className="text-background font-semibold mb-6">Företag</h4>
            <ul className="space-y-3">
          ...
          {/* Kontakt */}
          <div>
            <h4 className="text-background font-semibold mb-6">Kontakt</h4>
            <ul className="space-y-3">
